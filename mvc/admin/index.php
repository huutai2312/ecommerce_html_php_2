                ...
                <div class="col-lg-3">
                    <div class="card card-body mb-4">
                        <article class="icontext">
                            ...
                            <div class="text">
                                <h6 class="mb-1 card-title">Đơn Hàng</h6> <span>53.668</span>
                                <span class="text-sm">
                ...
                <div class="col-lg-3">
                    <div class="card card-body mb-4">
                        <article class="icontext">
                            ...
                            <div class="text">
                                <h6 class="mb-1 card-title">Các sản phẩm</h6> <span>9.856</span>
                                <span class="text-sm">
                                    Trong 19 hạng mục
                                </span>
                            </div>
                ...
                <div class="col-lg-3">
                    <div class="card card-body mb-4">
                        <article class="icontext">
                            ...
                            <div class="text">
                                <h6 class="mb-1 card-title">Thu nhập hàng tháng</h6> <span>$6,982</span>
                                <span class="text-sm">
                                    ...
                                    <div class="new-member-list">
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="../public/assets_admin/imgs/people/avatar4.jpg" alt="" class="avatar">
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="../public/assets_admin/imgs/people/avatar2.jpg" alt="" class="avatar">
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="../public/assets_admin/imgs/people/avatar3.jpg" alt="" class="avatar">
                                                <div>
