                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about__thumb d-flex">
                            <div class="about__thumb--items">
                                <img class="about__thumb--img border-radius-5 display-block" src="../public/assets_client/img/other/about-thumb-list1.png" alt="about-thumb">
                            </div>
                            <div class="about__thumb--items position__relative">
                                <img class="about__thumb--img border-radius-5 display-block" src="../public/assets_client/img/other/about-thumb-list2.png" alt="about-thumb">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            ...
                            <h2 class="about__content--maintitle mb-25">Một website bán  chuyên về các loại áo nam nữ, mang đến cho bạn sự lựa chọn đa dạng và phong cách độc đáo.</h2>
                            <p class="about__content--desc mb-20">Với Suruchi, chúng tôi cam kết mang đến cho bạn những sản phẩm thời trang chất lượng cao, được thiết kế tỉ mỉ và chăm chút từng chi tiết. Với sự tận tâm và chuyên nghiệp, đội ngũ nhân viên của chúng tôi luôn sẵn sàng hỗ trợ bạn trong quá trình mua sắm.</p>
                            <p class="about__content--desc mb-25">Chúng tôi tự hào về sự đa dạng của bộ sưu tập áo của mình, từ áo sơ mi thanh lịch cho nam giới đến váy đẹp và áo thun phong cách cho phái đẹp. Bất kể bạn muốn tìm kiếm một bộ trang phục công sở, trang phục dạo phố hay trang phục dự tiệc, Suruchi luôn có những lựa chọn phù hợp với sở thích và phong cách của bạn.</p>
                            <div class="about__author position__relative d-flex align-items-center">
                                ...
                                <img class="about__author--signature display-block" src="../public/assets_client/img/icon/signature.png" alt="signature">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="team__container">
                    <div class="row">
                        <div class="col-lg-2 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img border-radius-50" src="../public/assets_client/img/other/team1.png" alt="">
                                </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img border-radius-50" src="../public/assets_client/img/other/team2.png" alt="">
                                </div>
                                <div class="team__content">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img border-radius-50" src="../public/assets_client/img/other/team3.png" alt="">
                                </div>
                                <div class="team__content">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items text-center">
                                ...
                                <div class="testimonial__items--content">
                                    ...
                                    <p class="testimonial__items--desc">Rất hài lòng với trải nghiệm mua sắm trên website này. Họ có một bộ sưu tập đa dạng các loại áo nam nữ, từ áo thun đơn giản đến áo khoác sang trọng. Chất lượng sản phẩm rất tốt và giá cả cũng rất hợp lý. </p>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items text-center">
                                ...
                                <div class="testimonial__items--content">
                                    ...
                                    <span class="testimonial__items--subtitle">fashion</span>
                                    <p class="testimonial__items--desc">Tôi rất thích cách họ chăm sóc khách hàng, từ việc tư vấn kích cỡ cho đến hỗ trợ sau khi mua hàng. Đặc biệt, dịch vụ giao hàng nhanh chóng và sản phẩm đến tay tôi luôn đúng theo như tôi mong đợi. </p>
                                    <ul class="rating testimonial__rating d-flex justify-content-center">
                                        <li class="rating__list">
                                            <span class="rating__list--icon">
                                                <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="14.105" height="14.732" viewBox="0 0 10.105 9.732">
                    ...
                    <div class="col">
                        <div class="brand__logo--section__inner d-flex justify-content-center align-items-center">
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block" src="../public/assets_client/img/logo/brand-logo1.png" alt="brand logo">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block" src="../public/assets_client/img/logo/brand-logo2.png" alt="brand logo">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block" src="../public/assets_client/img/logo/brand-logo3.png" alt="brand logo">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block" src="../public/assets_client/img/logo/brand-logo4.png" alt="brand logo">
                            </div>
                            <div class="brand__logo--items">
                                <img class="brand__logo--items__thumbnail--img display-block" src="../public/assets_client/img/logo/brand-logo5.png" alt="brand logo">
                            </div>
                        </div>
                    </div>
                </div>
